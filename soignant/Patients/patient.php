...
<head>
    ...
    <link rel="stylesheet" href="patient.css?v=1.0">
...
<div class="main-content">
    ...
    <div class="patient-container">
        <div class="patient-title">
            <img src="../../images/user1.png" alt="Icon" class="patient-icon">
            ...
            <tbody>
                <?php foreach ($patients as $ligne): ?>
                    <tr>
                        ...
                        <td>
                        <a href="../chambre/chambre.php?numero=<?= urlencode($ligne['numerochambre']) ?>" class="chambre-lien">
