...
<body>
    <div class="sidebar">
        <div class="logo-container">
            <img src="../../images/bedmed.png" alt="BedMed Logo" class="logo">
            <span class="logo-text">BedMed</span>
        </div>

            <div class="dashboard" id="dashboard">
                <a href="dashboard.php" class="dashboard-btn" title="Dashboard">
                    <img src="../../images/dashboard3.png" class="dashboard-img" alt="logo dashboard">
                    <span class="dashboard-text">Accueil</span>    
                </a>
            </div>
            
            <div class="settings" id="settings">
                <a href="../../auth/logout.php" class="settings-btn" title="settings">
                    <img src="../../images/deco.png" class="settings-img" alt="deco settings">
            ...
            <div class="chambre" id="chambre">
                <a href="../chambre/liste_chambre.php" class="chambre-btn" title="chambre">
                    <img src="../../images/chambre3.png" class="chambre-img" alt="icon chambre">
                    <span class="chambre-text">Chambres</span>
                </a>
            </div>

        <div class="theme-toggle" id="theme-toggle">
            <img src="../../images/dark-theme.png" alt="darktheme icon" class="theme">
    ...
    <div class="main-content">
        <header>
            ...
            <div class="header-right">
                <a href="../../auth/logout.php" class="logout-btn" title="Déconnexion">
                    <img src="../../images/deco.png" class="deco-img" alt="Déconnexion">
                </a>
            </div>
        </header>
        ...
        <div class="cards">
            ...
            <div class="patient-card">
                ...
                <img src="../../images/patient.png" class="patient-icon" alt="icon patient">
            </div>
            </a>
            ...
            <a href="../Alerte/alertes.php" target="_blank" class="card red" title="alerte">
                <span class="alerte">Alerte </span>
                <img src="../../images/alerte.png" class="alerte-img" alt="Logo alerte">
            </a>
    </div>
